...
(
    ...
    slack_notification_interval_type int(11) DEFAULT '0' NOT NULL,
    slack_notification_interval      int(11) DEFAULT '0' NOT NULL,
    slack_notification_if_fixed      tinyint(4) DEFAULT '0' NOT NULL,
...
#
# Table structure for table 'tx_caretaker_notification_log'
#
CREATE TABLE tx_caretaker_notification_log
(

    uid         int(11) NOT NULL auto_increment,
    tstamp      int(11) DEFAULT '0' NOT NULL,
    deleted     tinyint(4) DEFAULT '0' NOT NULL,
    node_uid    int(11) DEFAULT '0' NOT NULL,
    result_hash varchar(255) DEFAULT '' NOT NULL,
