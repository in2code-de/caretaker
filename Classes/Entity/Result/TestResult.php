 ...
 *
 */
class TestResult extends NodeResult
{
    /**
    ...
    public static function undefined($message = 'Result is undefined')
    {
        ...
        return new self($timestamp, Constants::state_undefined, 0, $message);
    }
     ...
     * @return TestResult
     */
    public static function create($status = Constants::state_undefined, $value = 0, $message = '', $submessages = null)
    {
        $ts = time();
