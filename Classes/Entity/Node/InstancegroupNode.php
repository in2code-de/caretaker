 ...
 *
 */
class InstancegroupNode extends AggregatorNode
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct($uid, $title, $parent, Constants::table_Instancegroups, Constants::nodeType_Instancegroup, $hidden);
    }
    ...
    {
        $node_repository = NodeRepository::getInstance();
