 ...
 * $Id$
 */
class NotificationBaseExitPoint implements NotificationExitPointInterface
{
    /**
     * @var array
     */
...
';
    ...
    protected function getMarkersForNotification($notification)
    {
        ...
        return array(
            ...
            '###INSTANCE_TITLE###' => ($node instanceof AbstractNode && $node->getInstance() ?
                '"' . $node->getInstance()->getTitle() . '"' :
                '-'),
            '###INSTANCE_ID###' => ($node instanceof AbstractNode ?
